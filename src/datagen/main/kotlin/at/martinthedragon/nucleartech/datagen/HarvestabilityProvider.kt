...
class HarvestabilityProvider(dataGenerator: DataGenerator, existingFileHelper: ExistingFileHelper) : BlockTagsProvider(dataGenerator, NuclearTech.MODID, existingFileHelper) {
    ...
    private fun toolTypes() {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
            ...
            NTechBlocks.corium.get(), NTechBlocks.corebblestone.get(),
            ...
            NTechBlocks.rbmkColumn.get(),
            NTechBlocks.rbmkRod.get(), NTechBlocks.rbmkModeratedRod.get(), NTechBlocks.rbmkReaSimRod.get(), NTechBlocks.rbmkModeratedReaSimRod.get(),
            NTechBlocks.rbmkReflector.get(), NTechBlocks.rbmkModerator.get(), NTechBlocks.rbmkAbsorber.get(),
            NTechBlocks.rbmkBoilerColumn.get(), NTechBlocks.rbmkBoiler.get(),
            NTechBlocks.rbmkBlank.get(),
            NTechBlocks.rbmkManualControlRod.get(), NTechBlocks.rbmkModeratedControlRod.get(), NTechBlocks.rbmkAutoControlRod.get(),
            NTechBlocks.rbmkInlet.get(), NTechBlocks.rbmkOutlet.get(),
            NTechBlocks.rbmkConsole.get(),
            NTechBlocks.rbmkDebris.get(), NTechBlocks.rbmkBurningDebris.get(), NTechBlocks.rbmkRadioactiveDebris.get(),
