...
class NuclearBlockStateProvider(
    ...
    override fun registerStatesAndModels() {
        ...
        simpleBlock(ModBlocks.cobaltOre.get())
        simpleBlock(ModBlocks.deepslateUraniumOre.get())
        simpleBlock(ModBlocks.scorchedDeepslateUraniumOre.get())
        simpleBlock(ModBlocks.deepslateThoriumOre.get())
        simpleBlock(ModBlocks.deepslateTitaniumOre.get())
        simpleBlock(ModBlocks.deepslateSulfurOre.get())
        simpleBlock(ModBlocks.deepslateNiterOre.get())
        simpleBlock(ModBlocks.deepslateTungstenOre.get())
        simpleBlock(ModBlocks.deepslateAluminiumOre.get())
        simpleBlock(ModBlocks.deepslateFluoriteOre.get())
        simpleBlock(ModBlocks.deepslateBerylliumOre.get())
        simpleBlock(ModBlocks.deepslateLeadOre.get())
        simpleBlock(ModBlocks.deepslateOilDeposit.get())
        simpleBlock(ModBlocks.emptyDeepslateOilDeposit.get())
        simpleBlock(ModBlocks.deepslateAsbestosOre.get())
        simpleBlock(ModBlocks.deepslateSchrabidiumOre.get())
        simpleBlock(ModBlocks.deepslateAustralianOre.get())
        simpleBlock(ModBlocks.deepslateRareEarthOre.get())
        simpleBlock(ModBlocks.deepslateCobaltOre.get())
        ...
        logBlock(ModBlocks.charredLog.get())
        simpleBlock(ModBlocks.charredPlanks.get())
        simpleBlock(ModBlocks.slakedSellafite.get())
        simpleBlock(ModBlocks.sellafite.get())
        simpleBlock(ModBlocks.hotSellafite.get())
        simpleBlock(ModBlocks.boilingSellafite.get())
        simpleBlock(ModBlocks.blazingSellafite.get())
        simpleBlock(ModBlocks.infernalSellafite.get())
        ...
        horizontalBlock(ModBlocks.chemPlant.get(), models().getBuilder("chem_plant").texture("particle", "block/chem_plant/chem_plant_particles"))
        ...
        copiedBlockItem(ModBlocks.cobaltOre.get())
        copiedBlockItem(ModBlocks.deepslateUraniumOre.get())
        copiedBlockItem(ModBlocks.scorchedDeepslateUraniumOre.get())
        copiedBlockItem(ModBlocks.deepslateThoriumOre.get())
        copiedBlockItem(ModBlocks.deepslateTitaniumOre.get())
        copiedBlockItem(ModBlocks.deepslateSulfurOre.get())
        copiedBlockItem(ModBlocks.deepslateNiterOre.get())
        copiedBlockItem(ModBlocks.deepslateTungstenOre.get())
        copiedBlockItem(ModBlocks.deepslateAluminiumOre.get())
        copiedBlockItem(ModBlocks.deepslateFluoriteOre.get())
        copiedBlockItem(ModBlocks.deepslateBerylliumOre.get())
        copiedBlockItem(ModBlocks.deepslateLeadOre.get())
        copiedBlockItem(ModBlocks.deepslateOilDeposit.get())
        copiedBlockItem(ModBlocks.emptyDeepslateOilDeposit.get())
        copiedBlockItem(ModBlocks.deepslateAsbestosOre.get())
        copiedBlockItem(ModBlocks.deepslateSchrabidiumOre.get())
        copiedBlockItem(ModBlocks.deepslateAustralianOre.get())
        copiedBlockItem(ModBlocks.deepslateRareEarthOre.get())
        copiedBlockItem(ModBlocks.deepslateCobaltOre.get())
        ...
        copiedBlockItem(ModBlocks.charredLog.get())
        copiedBlockItem(ModBlocks.charredPlanks.get())
        copiedBlockItem(ModBlocks.slakedSellafite.get())
        copiedBlockItem(ModBlocks.sellafite.get())
        copiedBlockItem(ModBlocks.hotSellafite.get())
        copiedBlockItem(ModBlocks.boilingSellafite.get())
        copiedBlockItem(ModBlocks.blazingSellafite.get())
        copiedBlockItem(ModBlocks.infernalSellafite.get())
