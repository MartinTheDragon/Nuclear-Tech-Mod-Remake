...
class TemplateFolderJeiRecipeCategory(guiHelper: IGuiHelper) : IRecipeCategory<TemplateFolderJeiRecipeCategory.TemplateFolderRecipe> {
    ...
    override fun getTitle() = "Template Folder"

    override fun getTitleAsTextComponent() = TranslationTextComponent("jei.${NuclearTech.MODID}.category.template_folder_results")
