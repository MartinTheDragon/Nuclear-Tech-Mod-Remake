...
class PressingRecipe(
    ...
    enum class StampType(val tag: TagKey<Item>) {
        FLAT(NTechTags.Items.FLAT_STAMPS),
        PLATE(NTechTags.Items.PLATE_STAMPS),
        WIRE(NTechTags.Items.WIRE_STAMPS),
        CIRCUIT(NTechTags.Items.CIRCUIT_STAMPS),

        ANY(NTechTags.Items.STAMPS);
    ...
    override fun getToastSymbol() = ItemStack(NTechBlocks.steamPressBase.get())
