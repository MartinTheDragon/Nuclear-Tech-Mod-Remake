...
class SpecialModelMultiBlockPlacerItem(block: Block, blockEntityFunc: (BlockPos, BlockState) -> BlockEntity, val placerFunc: (MultiBlockPlacer) -> Unit, properties: Properties) : SpecialModelBlockItem(block, blockEntityFunc, properties) {
