...
class NuclearRecipeProvider(generator: DataGenerator) : RecipeProvider(generator) {
    ...
    private fun machineItems(consumer: Consumer<IFinishedRecipe>) {
        // TODO make special crafting recipes that sum up already existing energy
//        ShapedRecipeBuilder.shaped(ModItems.battery.get()).define('W', NuclearTags.Items.WIRES_ALUMINIUM).define('P', NuclearTags.Items.PLATES_ALUMINIUM).define('R', Tags.Items.DUSTS_REDSTONE).pattern(" W ").pattern("PRP").pattern("PRP").unlockedBy("has_aluminium_ingot", has(NuclearTags.Items.INGOTS_ALUMINIUM)).save(consumer, ModItems.battery.id)
//        ShapedRecipeBuilder.shaped(ModItems.redstonePowerCell.get()).define('W', NuclearTags.Items.WIRES_ALUMINIUM).define('P', NuclearTags.Items.PLATES_ALUMINIUM).define('B', ModItems.battery.get()).pattern("WBW").pattern("PBP").pattern("WBW").unlockedBy("has_battery", has(ModItems.battery.get())).save(consumer, ModItems.redstonePowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.sixfoldRedstonePowerCell.get()).define('W', NuclearTags.Items.WIRES_ALUMINIUM).define('P', NuclearTags.Items.PLATES_ALUMINIUM).define('B', ModItems.redstonePowerCell.get()).pattern("BBB").pattern("WPW").pattern("BBB").unlockedBy("has_battery", has(ModItems.redstonePowerCell.get())).save(consumer, ModItems.sixfoldRedstonePowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.twentyFourFoldRedstonePowerCell.get()).define('W', NuclearTags.Items.WIRES_ALUMINIUM).define('P', NuclearTags.Items.PLATES_ALUMINIUM).define('B', ModItems.sixfoldRedstonePowerCell.get()).pattern("BWB").pattern("WPW").pattern("BWB").unlockedBy("has_battery", has(ModItems.sixfoldRedstonePowerCell.get())).save(consumer, ModItems.twentyFourFoldRedstonePowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.advancedBattery.get()).define('W', ModItems.redCopperWire.get()).define('P', NuclearTags.Items.PLATES_COPPER).define('S', NuclearTags.Items.DUSTS_SULFUR).define('L', NuclearTags.Items.DUSTS_LEAD).pattern(" W ").pattern("PSP").pattern("PLP").unlockedBy("has_sulfur", has(NuclearTags.Items.DUSTS_SULFUR)).save(consumer, ModItems.advancedBattery.id)
//        ShapedRecipeBuilder.shaped(ModItems.advancedPowerCell.get()).define('W', ModItems.redCopperWire.get()).define('P', NuclearTags.Items.PLATES_COPPER).define('B', ModItems.advancedBattery.get()).pattern("WBW").pattern("PBP").pattern("WBW").unlockedBy("has_battery", has(ModItems.advancedBattery.get())).save(consumer, ModItems.advancedPowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.quadrupleAdvancedPowerCell.get()).define('W', ModItems.redCopperWire.get()).define('P', NuclearTags.Items.PLATES_COPPER).define('B', ModItems.quadrupleAdvancedPowerCell.get()).pattern("BWB").pattern("WPW").pattern("BWB").unlockedBy("has_battery", has(ModItems.advancedPowerCell.get())).save(consumer, ModItems.quadrupleAdvancedPowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.twelveFoldAdvancedPowerCell.get()).define('W', ModItems.redCopperWire.get()).define('P', NuclearTags.Items.PLATES_COPPER).define('B', ModItems.quadrupleAdvancedPowerCell.get()).pattern("WPW").pattern("BBB").pattern("WPW").unlockedBy("has_battery", has(ModItems.quadrupleAdvancedPowerCell.get())).save(consumer, ModItems.twelveFoldAdvancedPowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.lithiumBattery.get()).define('W', NuclearTags.Items.WIRES_GOLD).define('P', NuclearTags.Items.PLATES_TITANIUM).define('L', NuclearTags.Items.DUSTS_LITHIUM).define('C', NuclearTags.Items.DUSTS_COBALT).pattern("W W").pattern("PLP").pattern("PCP").unlockedBy("has_lithium", has(NuclearTags.Items.DUSTS_LITHIUM)).save(consumer, ModItems.lithiumBattery.id)
//        ShapedRecipeBuilder.shaped(ModItems.lithiumPowerCell.get()).define('W', NuclearTags.Items.WIRES_GOLD).define('P', NuclearTags.Items.PLATES_TITANIUM).define('B', ModItems.lithiumBattery.get()).pattern("WBW").pattern("PBP").pattern("WBW").unlockedBy("has_battery", has(ModItems.lithiumBattery.get())).save(consumer, ModItems.lithiumPowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.tripleLithiumPowerCell.get()).define('W', NuclearTags.Items.WIRES_GOLD).define('P', NuclearTags.Items.PLATES_TITANIUM).define('B', ModItems.lithiumPowerCell.get()).pattern("WPW").pattern("BBB").pattern("WPW").unlockedBy("has_battery", has(ModItems.lithiumPowerCell.get())).save(consumer, ModItems.tripleLithiumPowerCell.id)
//        ShapedRecipeBuilder.shaped(ModItems.sixfoldLithiumPowerCell.get()).define('W', NuclearTags.Items.WIRES_GOLD).define('P', NuclearTags.Items.PLATES_TITANIUM).define('B', ModItems.tripleLithiumPowerCell.get()).pattern("WPW").pattern("BWB").pattern("WPW").unlockedBy("has_battery", has(ModItems.tripleLithiumPowerCell.get())).save(consumer, ModItems.sixfoldLithiumPowerCell.id)
