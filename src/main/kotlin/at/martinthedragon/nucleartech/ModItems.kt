...
object ModItems {
    ...
    val actiniumIngot = ITEMS.registerK("actinium_ingot") { Item(PARTS_TAB_PROP) }
    ...
    val actiniumPowder = ITEMS.registerK("actinium_powder") { Item(PARTS_TAB_PROP) }
    ...
    val actiniumFragment = ITEMS.registerK("actinium_fragment") { Item(PARTS_TAB_PROP) }
    ...
    val poloniumNugget = ITEMS.registerK("polonium_nugget") { Item(PARTS_TAB_PROP) }
