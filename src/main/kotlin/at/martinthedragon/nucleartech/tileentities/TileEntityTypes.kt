...
object TileEntityTypes {
    val safeTileEntityType: RegistryObject<TileEntityType<SafeTileEntity>> = TILE_ENTITIES.register("safe") { TileEntityType.Builder.of(::SafeTileEntity, ModBlocks.safe.get()).build() }
    val sirenTileEntityType: RegistryObject<TileEntityType<SirenTileEntity>> = TILE_ENTITIES.register("siren") { TileEntityType.Builder.of(::SirenTileEntity, ModBlocks.siren.get()).build() }
    val steamPressHeadTileEntityType: RegistryObject<TileEntityType<SteamPressTopTileEntity>> = TILE_ENTITIES.register("steam_press_top") { TileEntityType.Builder.of(::SteamPressTopTileEntity, ModBlocks.steamPressTop.get()).build() }
    val blastFurnaceTileEntityType: RegistryObject<TileEntityType<BlastFurnaceTileEntity>> = TILE_ENTITIES.register("blast_furnace") { TileEntityType.Builder.of(::BlastFurnaceTileEntity, ModBlocks.blastFurnace.get()).build() }
