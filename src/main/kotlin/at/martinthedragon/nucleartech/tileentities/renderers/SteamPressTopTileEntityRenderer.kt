package at.martinthedragon.nucleartech.tileentities.renderers
...
class SteamPressTopTileEntityRenderer(tileEntityRendererDispatcher: TileEntityRendererDispatcher) :
    ...
    companion object {
        val PRESS_HEAD_RESOURCE_LOCATION = RenderMaterial(PlayerContainer.BLOCK_ATLAS, ResourceLocation(NuclearTech.MODID, "block/steam_press/steam_press_head"))
    }
}
