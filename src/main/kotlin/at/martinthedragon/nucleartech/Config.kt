...
import at.martinthedragon.nucleartech.WorldGeneration.OreGenerationSettings
import at.martinthedragon.nucleartech.WorldGeneration.netherBiomes
...
object Config {
    ...
    fun createConfig() {
        ...
        configData = CommentedFileConfig.builder(FMLPaths.CONFIGDIR.get().resolve("nucleartech-common.toml"))
                .sync()
                .autosave()
                .autoreload()
