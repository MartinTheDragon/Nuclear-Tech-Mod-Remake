...
class MainPlugin : ModPlugin {
    ...
    override fun registerHazmatValues(hazmat: HazmatRegistry): Unit = with(hazmat) {
        ...
        registerArmorRepairItem(ModItems.hazmatCloth, .6F)
        registerArmorRepairItem(ModItems.advancedHazmatCloth, 1F)
        registerArmorRepairItem(ModItems.leadReinforcedHazmatCloth, 2F)
