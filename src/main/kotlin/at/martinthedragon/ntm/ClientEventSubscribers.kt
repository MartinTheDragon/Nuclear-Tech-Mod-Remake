...
@Mod.EventBusSubscriber(Dist.CLIENT, modid = Main.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
object ClientEventSubscribers {
    @SubscribeEvent @JvmStatic
    fun onTagsUpdated(event: TagsUpdatedEvent) {
        Main.LOGGER.debug("Reloading Machine Template Folder search tree")
