...
import at.martinthedragon.ntm.RegistriesAndLifecycle.BLOCKS
...
object ModBlocks {
    ...
    val insulatorRoll: RegistryObject<Block> = BLOCKS.register("insulator_roll") { RotatedPillarBlock(Properties.of(METAL).strength(6f).harvestLevel(1).harvestTool(ToolType.PICKAXE).sound(SoundType.METAL)) }
    val fiberglassRoll: RegistryObject<Block> = BLOCKS.register("fiberglass_roll") { RotatedPillarBlock(Properties.of(METAL).strength(6f).harvestLevel(1).harvestTool(ToolType.PICKAXE).sound(SoundType.METAL)) }
    ...
    val titaniumDecoBlock: RegistryObject<Block> = BLOCKS.register("titanium_deco_blcok") { Block(Properties.of(METAL).strength(6f).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.METAL)) }
