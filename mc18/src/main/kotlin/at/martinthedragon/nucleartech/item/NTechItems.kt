...
object NTechItems {
    ...
    // Siren Tracks
    val sirenTrackHatchSiren = ITEMS.registerK("siren_track_hatch_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackHatchSiren, 250, true, 0x334077) }
    val sirenTrackAutopilotDisconnected = ITEMS.registerK("siren_track_autopilot_disconnected") { SirenTrackItem(NTechSoundsCore.sirenTrackAutopilotDisconnected, 50, true, 0xB5B5B5) }
    val sirenTrackAMSSiren = ITEMS.registerK("siren_track_ams_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackAMSSiren, 100, true, 0xE5BB52) }
    val sirenTrackBlastDoorAlarm = ITEMS.registerK("siren_track_blast_door_alarm") { SirenTrackItem(NTechSoundsCore.sirenTrackBlastDoorAlarm, 50, true, 0xB20000) }
    val sirenTrackAPCSiren = ITEMS.registerK("siren_track_apc_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackAPCSiren, 100, true, 0x3666A0) }
    val sirenTrackKlaxon = ITEMS.registerK("siren_track_klaxon") { SirenTrackItem(NTechSoundsCore.sirenTrackKlaxon, 50, true, 0x808080) }
    val sirenTrackVaultDoorAlarm = ITEMS.registerK("siren_track_vault_door_alarm") { SirenTrackItem(NTechSoundsCore.sirenTrackVaultDoorAlarm, 50, true, 0x8C810B) }
    val sirenTrackSecurityAlert = ITEMS.registerK("siren_track_security_alert") { SirenTrackItem(NTechSoundsCore.sirenTrackSecurityAlert, 50, true, 0x76818E) }
    val sirenTrackStandardSiren = ITEMS.registerK("siren_track_standard_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackStandardSiren, 250, true, 0x660000) }
    val sirenTrackClassicSiren = ITEMS.registerK("siren_track_classic_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackClassicSiren, 250, true, 0xC0CFE8) }
    val sirenTrackBankAlarm = ITEMS.registerK("siren_track_bank_alarm") { SirenTrackItem(NTechSoundsCore.sirenTrackBankAlarm, 100, true, 0x3684E2) }
    val sirenTrackBeepSiren = ITEMS.registerK("siren_track_beep_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackBeepSiren, 100, true, 0xD3D3D3) }
    val sirenTrackContainerAlarm = ITEMS.registerK("siren_track_container_alarm") { SirenTrackItem(NTechSoundsCore.sirenTrackContainerAlarm, 100, true, 0xE0BA9F) }
    val sirenTrackSweepSiren = ITEMS.registerK("siren_track_sweep_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackSweepSiren, 500, true, 0xEDEA5A) }
    val sirenTrackMissileSiloSiren = ITEMS.registerK("siren_track_missile_silo_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackMissileSiloSiren, 500, true, 0xABAB9A) }
    val sirenTrackAirRaidSiren = ITEMS.registerK("siren_track_air_raid_siren") { SirenTrackItem(NTechSoundsCore.sirenTrackAirRaidSiren, 1000, false, 0xDF3795) }
    val sirenTrackNostromoSelfDestruct = ITEMS.registerK("siren_track_nostromo_self_destruct") { SirenTrackItem(NTechSoundsCore.sirenTrackNostromoSelfDestruct, 100, true, 0x5DD800) }
    val sirenTrackEASAlarmScreech = ITEMS.registerK("siren_track_eas_alarm_screech") { SirenTrackItem(NTechSoundsCore.sirenTrackEASAlarmScreech, 50, true, 0xB3A8C1) }
    val sirenTrackAPCPass = ITEMS.registerK("siren_track_apc_pass") { SirenTrackItem(NTechSoundsCore.sirenTrackAPCPass, 50, false, 0x3437D3) }
    val sirenTrackRazortrainHorn = ITEMS.registerK("siren_track_razortrain_horn") { SirenTrackItem(NTechSoundsCore.sirenTrackRazortrainHorn, 250, false, 0x7750ED) }
