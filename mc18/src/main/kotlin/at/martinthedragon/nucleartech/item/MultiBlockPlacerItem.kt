...
class MultiBlockPlacerItem(block: Block, val placerFunc: (MultiBlockPlacer) -> Unit, properties: Properties, override val additionalRange: Float = 0F) : BlockItem(block, properties), IncreasedRangeItem {
