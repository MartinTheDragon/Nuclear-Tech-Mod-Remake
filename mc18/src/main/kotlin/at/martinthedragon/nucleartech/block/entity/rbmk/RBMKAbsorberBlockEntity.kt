...
class RBMKAbsorberBlockEntity(pos: BlockPos, state: BlockState) : NoInventoryRBMKBaseBlockEntity(BlockEntityTypes.rbmkAbsorberBlockEntityType.get(), pos, state) {
    ...
    override val consoleType = RBMKConsoleBlockEntity.Column.Type.ABSORBER
